...
COPY public."GradeAffectation" ("idAffectation", "Name") FROM stdin;
\.
...
COPY public.locations (latitude, longitude, "nameLocation", "idLocations", "idReport") FROM stdin;
\.
...
SELECT pg_catalog.setval('public."Affectation_idAffectation_seq"', 48, true);
